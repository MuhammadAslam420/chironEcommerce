                        ...
                        <div class="filter__mobile">
                            <div class="viewtype--block">
                                ...
                                <div class="viewtype__select"> <span class="text ps-mobile-filter"><i class="icon-equalizer"></i>Filter</span>
                                    <div class="type"><a href="/shop"><span class="active"><i class="fa fa-th"></i></span></a><a href="href="{{route('list-view')}}""><span><i class="fa fa-list"></i></span></a></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="section-shop--grid">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3 p-0">
                                        <div class="ps-product--standard" wire:ignore><a href="{{route('product-detail',['id'=>$product->id])}}">
                                                <img class="ps-product__thumbnail" src="https://app.chiron.ae/storage/app/public/product/{{json_decode($product['image'],true)[0]}}" style="height:90px;" alt="{{$product->name}}" /></a>
