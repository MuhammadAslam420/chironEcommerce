    ...
    <div class="ps-breadcrumb">
        <div class="container">
            <ul class="ps-breadcrumb__list">
                ...
                <li><a href="javascript:void(0);">Today Deals</a></li>
            </ul>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="result__header">
                            <h4 class="title" style="font-size:13px;">{{$products->count()}}<span style="font-size:13px;">Product Found</span></h4>
                        ...
                        <div class="filter__mobile">
                            <div class="viewtype--block">
                                ...
                                <div class="viewtype__select"> <span class="text ps-mobile-filter"><i class="icon-equalizer"></i>Filter</span>
                                    <div class="type"><a href="/shop"><span class="active"><i class="fa fa-th"></i></span></a><a href="{{route('list-view')}}"><span><i class="fa fa-list"></i></span></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result__content">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3 p-0">
                                        <div class="ps-product--standard"><a href="{{route('product-detail',['id'=>$product->id])}}">
                                                <img class="ps-product__thumbnail" src="https://app.chiron.ae/storage/app/public/product/{{json_decode($product['image'],true)[0]}}"style="height:90px;" alt="{{$product->name}}" height="100"/></a>
                                            ...
                                            <div class="ps-product__content">
                                                ...
                                                <h5><a class="ps-product__name" href="{{route('product-detail',['id'=>$product->id])}}">{{ Str::limit($product->name,15)}}</a></h5>
                                            ...
                                            <div class="justify-content-center">
                                                <div class="def-number-input number-input safari_only">
                                                    <button class="minus bg-danger" onclick="this.parentNode.querySelector('input[type=number]').stepDown()"><i class="fa fa-minus p-1 text-light"></i></button>
                                                    <input class="quantity" min="0" name="quantity" value="1" type="number" />
                                                    <button class="plus bg-success" onclick="this.parentNode.querySelector('input[type=number]').stepUp()"><i class="fa fa-plus p-1 text-light"></i></button>
                                                </div>
                                                @if($product->discount > 0)
                                                @php
                                                $d_price=0;
                            ...
                            <div class="col-md-12  mt-2"><spna class="float-right">{{$products->links('pagination::bootstrap-4')}}</spna></div>
